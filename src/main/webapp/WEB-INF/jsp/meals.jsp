            ...
            <section>
                ...
                <form method="post" action="meals/filter" id="filterForm">
                    ...
                    <div class="btn-group">
                        ...
                        <button class="btn btn-reset" type="button" onclick="resetFilter()"><spring:message code="common.reset"/></button>
                    </div>
                </form>
                <hr>
                ...
                <div class="view-box">
                    ...
                    <hr>
                    <table class="table table-striped display" id="datatableMeal">
                        <thead>
                        <tr>
                        ...
                        <c:forEach items="${meals}" var="meal">
                            ...
                            <tr class="${meal.exceed ? 'exceeded' : 'normal'}">
                                ...
                                <td>${meal.calories}</td>
                                <td><a href="meals/update?id=${meal.id}"><span class="glyphicon glyphicon-pencil"
                                                                               aria-hidden="true"></span></a></td>
                                <td><a onclick="deleteRow(${meal.id})"><span
